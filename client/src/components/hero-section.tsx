...
import usanaMarketingBg from "@assets/건강구독마케팅-네트워크마케팅 유사나 박현진 pc31_1752996262032.png";
            ...
            <div className="space-y-4">
              ...
              <div className="inline-block mt-12 mb-2">
                <div className="relative bg-gradient-to-r from-amber-500/90 to-orange-500/90 backdrop-blur-sm border-2 border-amber-400/50 rounded-2xl px-8 py-4 shadow-2xl shadow-amber-500/30">
                  ...
                  <p className="relative text-base sm:text-lg md:text-xl text-white font-bold tracking-wide text-center">
                    "프리미엄 영양제를<br />돈벌면서 마음껏 누리세요!!"
                  </p>
                </div>
              </div>
            </div>
