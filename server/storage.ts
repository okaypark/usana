    ...
    const defaultFaqs: Omit<Faq, 'id'>[] = [
      {
        ...
        answer: "✅ USANA는 FDA 승인 시설에서 제조되며, 세계 최초로 NSF 국제인증을 받은 건강기능식품 회사입니다.\n\n🔬 모든 제품은 엄격한 품질 관리 시스템을 거쳐 생산되며, 비교 가이드에서 15년 연속 1위 등급을 받을 정도로 안전성과 효능이 검증되어 있습니다. ⭐",
        category: "product",
        order: 1
      },
      {
      ...
      {
        question: "네트워크 마케팅이 피라미드 판매와 다른 점은 무엇인가요? ⚖️",
        answer: "✅ USANA는 합법적인 다단계 직접판매업체로 공정거래위원회에 신고된 정당한 사업입니다.\n\n🛡️ 피라미드 판매와 달리, 실제 우수한 제품의 판매를 기반으로 하며, 가입비나 후원수수료 없이 제품 판매 실적에 따른 투명한 수수료 체계를 운영합니다. 📊",
        category: "business",
        order: 4
      },
      {
        question: "제품 효과를 언제부터 느낄 수 있나요? ⏰",
        answer: "📈 개인차가 있지만, 대부분의 고객분들이 2-4주 내에 에너지 증가, 수면의 질 개선 등의 변화를 경험합니다.\n\n💪 꾸준히 복용하실 경우 2-3개월 후 더욱 뚜렷한 건강상의 개선을 느끼실 수 있습니다. 개인의 건강 상태와 생활 습관에 따라 차이가 있을 수 있습니다. ✨",
        category: "product",
        order: 5
      },
      {
