  ...
  private initializeFaqs() {
    const defaultFaqs: Omit<Faq, 'id'>[] = [
      ...
      },
      {
        ...
        answer: "유사나는 건강구독 기본소비만으로 하부의 소비 인프라에 대한 무한단계의 포인트 적립에 대한 일정 캐쉬백을 모두 지급합니다. 다른 다단계처럼 매월 무리한 판매매출조건이 없어서, 건강을 지키는 소비를 하면서 매출 압박 없이 편안하게 지인들에게 좋은 체험과 건강한 변화를 알려주시고 건강구독으로 10% 할인에서 완전 무료로 드실 수 있는 방법을 안내해주시면 됩니다.",
        category: "business",
        order: 7
      }
    ];
