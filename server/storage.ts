  ...
  private initializeFaqs() {
    const defaultFaqs: Omit<Faq, 'id'>[] = [
      ...
      },
      {
        ...
        answer: "하위 건강구독자들의 소비가 무제한 포인트로 누적되며, 기본 건강구독으로 자연스러운 소비만으로도 모든 캐시백이 지급되는 구조입니다. 일반적인 다단계처럼 매달 과도한 판매 조건이 없기 때문에, 지인들에게 부담 없이 좋은 제품 경험과 건강한 변화를 소개할 수 있습니다. 인프라가 확장될수록, 매달 건강 구독을 무료로 누릴 수 있을 뿐 아니라, 소비만으로도 추가 수익을 창출할 수 있는 시스템입니다.",
        category: "business",
        order: 7
      }
    ];
